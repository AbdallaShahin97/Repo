...
void setup() {
  ...
  joint2.setMaxSpeed(4000);
  joint3.setMaxSpeed(4000);   /// try to add acceleration
  joint4.setMaxSpeed(4000);
  joint5.setMaxSpeed(4000);
  joint6.setMaxSpeed(4000);
  joint7.setMaxSpeed(4000);
