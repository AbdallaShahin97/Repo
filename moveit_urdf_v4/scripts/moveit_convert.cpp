...
int stepsPerRevolution[7] = {800,800,800,800,800,800,800}; // microsteps/revolution (using 16ths) from observation, for each motor
int joint_status = 0;
double cur_angle[7];
int joint_step[7];
...
*/
  ...
  arm_steps.position1 = (int)((cmd_arm.position[0]-init_angle[0])*stepsPerRevolution[0]*(640)/0.7);
  arm_steps.position2 = (int)((cmd_arm.position[1]-init_angle[1])*stepsPerRevolution[1]*(8)/(2*M_PI));
  arm_steps.position3 = (int)((cmd_arm.position[2]-init_angle[2])*stepsPerRevolution[2]*(60)/(2*M_PI));
  arm_steps.position4 = (int)((cmd_arm.position[3]-init_angle[3])*stepsPerRevolution[3]*(20)/(2*M_PI));
  arm_steps.position5 = (int)((cmd_arm.position[4]-init_angle[4])*stepsPerRevolution[4]*(10)/(2*M_PI));
  arm_steps.position6 = (int)((cmd_arm.position[5]-init_angle[5])*stepsPerRevolution[5]*(10)/(2*M_PI));
  arm_steps.position7 = (int)((cmd_arm.position[6]-init_angle[6])*stepsPerRevolution[6]*(10)/(2*M_PI));
